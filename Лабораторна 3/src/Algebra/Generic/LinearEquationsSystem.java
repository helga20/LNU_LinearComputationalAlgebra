...
public class LinearEquationsSystem {
    ...
    public int getEquationsNumber(){
        return this.LeftSideMatrix.getRows();
    }
    ...
    public static LinearEquationsSystem random(int equations, double min, double max, boolean ensure_solutions) {
        return new LinearEquationsSystem(
                Matrix.randomMatrix(equations, equations, min, max, ensure_solutions),
                Matrix.randomMatrix(equations, 1, min, max, false)
        );
    }
